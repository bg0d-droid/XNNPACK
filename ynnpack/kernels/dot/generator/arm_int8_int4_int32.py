...
int8x16_t b_{k}_{j}_zip0 = vzip1q_s8(b_{k}_{j}_e, b_{k}_{j}_o);
int8x16_t b_{k}_{j}_zip2 = vzip2q_s8(b_{k}_{j}_e, b_{k}_{j}_o);
int8x16_t b_{k+0}_{j} = vreinterpretq_s8_s32(vuzp1q_s32(vreinterpretq_s32_s8(b_{k}_{j}_zip0), vreinterpretq_s32_s8(b_{k}_{j}_zip2)));
int8x16_t b_{k+4}_{j} = vreinterpretq_s8_s32(vuzp2q_s32(vreinterpretq_s32_s8(b_{k}_{j}_zip0), vreinterpretq_s32_s8(b_{k}_{j}_zip2)));
"""
